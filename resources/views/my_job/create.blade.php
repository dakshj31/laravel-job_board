        ...
        <x-card class="mb-8">
            <form action=" {{ route('my-jobs.store') }} " method="POST">
                ...
                <div class="mb-4 grid grid-cols-2 gap-4">
                    <div>
                        <x-label for="title" :required="true">Job Tilte</x-label>
                    ...
                    <div>
                        ...
                        <x-radio-group name="experience" :value="old('experiece')" 
                        :all-option="false" :options="array_combine(array_map('ucfirst', \App\Models\Job::$experience),
